...
class ImageAnalysisAgent:
    """
    Agent responsible for processing image uploads and classifying them
    as medical or non-medical, and determining their type.
    """
    ...
    def __init__(self, config):
        ...
        # Chest X-ray model is optional because the trained weights may
        # not be included with the project.
        ...
        try:
            ...
            print(f"Warning: Chest X-ray model unavailable: {e}")
        ...
        self.skin_lesion_segmentation_output_path = (
            config.medical_cv.skin_lesion_segmentation_output_path
        )
    ...
    def classify_chest_xray(self, image_path: str) -> str:
        if self.chest_xray_agent is None:
            return "Chest X-ray model is unavailable."
